M:error
S:Lerror.set_2bpp_palette$palette$1_0$26({2}SI:U),B,1,-2
S:Lerror.set_1bpp_colors$bgcolor$1_0$29({1}SC:U),B,1,-1
S:Lerror.set_1bpp_colors$fgcolor$1_0$29({1}SC:U),B,1,-2
S:Lerror.set_bkg_based_tiles$w$1_0$35({1}SC:U),B,1,2
S:Lerror.set_bkg_based_tiles$h$1_0$35({1}SC:U),B,1,3
S:Lerror.set_bkg_based_tiles$tiles$1_0$35({2}DG,SC:U),B,1,4
S:Lerror.set_bkg_based_tiles$base_tile$1_0$35({1}SC:U),B,1,6
S:Lerror.set_bkg_based_tiles$y$1_0$35({1}SC:U),B,1,-1
S:Lerror.set_bkg_based_tiles$x$1_0$35({1}SC:U),B,1,-2
S:Lerror.set_bkg_based_submap$w$1_0$38({1}SC:U),B,1,2
S:Lerror.set_bkg_based_submap$h$1_0$38({1}SC:U),B,1,3
S:Lerror.set_bkg_based_submap$map$1_0$38({2}DG,SC:U),B,1,4
S:Lerror.set_bkg_based_submap$map_w$1_0$38({1}SC:U),B,1,6
S:Lerror.set_bkg_based_submap$base_tile$1_0$38({1}SC:U),B,1,7
S:Lerror.set_bkg_based_submap$y$1_0$38({1}SC:U),B,1,-1
S:Lerror.set_bkg_based_submap$x$1_0$38({1}SC:U),B,1,-2
S:Lerror.move_bkg$y$1_0$43({1}SC:U),B,1,-1
S:Lerror.move_bkg$x$1_0$43({1}SC:U),B,1,-2
S:Lerror.scroll_bkg$y$1_0$45({1}SC:S),B,1,-1
S:Lerror.scroll_bkg$x$1_0$45({1}SC:S),B,1,-2
S:Lerror.set_win_based_tiles$w$1_0$52({1}SC:U),B,1,2
S:Lerror.set_win_based_tiles$h$1_0$52({1}SC:U),B,1,3
S:Lerror.set_win_based_tiles$tiles$1_0$52({2}DG,SC:U),B,1,4
S:Lerror.set_win_based_tiles$base_tile$1_0$52({1}SC:U),B,1,6
S:Lerror.set_win_based_tiles$y$1_0$52({1}SC:U),B,1,-1
S:Lerror.set_win_based_tiles$x$1_0$52({1}SC:U),B,1,-2
S:Lerror.set_win_based_submap$w$1_0$55({1}SC:U),B,1,2
S:Lerror.set_win_based_submap$h$1_0$55({1}SC:U),B,1,3
S:Lerror.set_win_based_submap$map$1_0$55({2}DG,SC:U),B,1,4
S:Lerror.set_win_based_submap$map_w$1_0$55({1}SC:U),B,1,6
S:Lerror.set_win_based_submap$base_tile$1_0$55({1}SC:U),B,1,7
S:Lerror.set_win_based_submap$y$1_0$55({1}SC:U),B,1,-1
S:Lerror.set_win_based_submap$x$1_0$55({1}SC:U),B,1,-2
S:Lerror.move_win$y$1_0$60({1}SC:U),B,1,-1
S:Lerror.move_win$x$1_0$60({1}SC:U),B,1,-2
S:Lerror.scroll_win$y$1_0$62({1}SC:S),B,1,-1
S:Lerror.scroll_win$x$1_0$62({1}SC:S),B,1,-2
S:Lerror.SET_SHADOW_OAM_ADDRESS$address$1_0$67({2}DG,SV:S),B,1,-2
S:Lerror.set_sprite_tile$tile$1_0$69({1}SC:U),B,1,-1
S:Lerror.set_sprite_tile$nb$1_0$69({1}SC:U),B,1,-2
S:Lerror.get_sprite_tile$nb$1_0$71({1}SC:U),B,1,-1
S:Lerror.set_sprite_prop$prop$1_0$73({1}SC:U),B,1,-1
S:Lerror.set_sprite_prop$nb$1_0$73({1}SC:U),B,1,-2
S:Lerror.get_sprite_prop$nb$1_0$75({1}SC:U),B,1,-1
S:Lerror.move_sprite$y$1_0$77({1}SC:U),B,1,2
S:Lerror.move_sprite$x$1_0$77({1}SC:U),B,1,-1
S:Lerror.move_sprite$nb$1_0$77({1}SC:U),B,1,-2
S:Lerror.move_sprite$itm$1_0$78({2}DG,STOAM_item_t:S),B,1,-4
S:Lerror.scroll_sprite$y$1_0$79({1}SC:S),B,1,2
S:Lerror.scroll_sprite$x$1_0$79({1}SC:S),B,1,-1
S:Lerror.scroll_sprite$nb$1_0$79({1}SC:U),B,1,-2
S:Lerror.scroll_sprite$itm$1_0$80({2}DG,STOAM_item_t:S),B,1,-4
S:Lerror.hide_sprite$nb$1_0$81({1}SC:U),B,1,-1
S:Lerror.set_native_tile_data$data$1_0$89({2}DG,SC:U),B,1,2
S:Lerror.set_native_tile_data$nb_tiles$1_0$89({1}SC:U),B,1,-1
S:Lerror.set_native_tile_data$first_tile$1_0$89({2}SI:U),B,1,-3
F:G$raise_error$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lerror.raise_error$how$1_0$117({2}DG,SC:S),B,1,2
S:Lerror.raise_error$who$1_0$0({1}SC:U),R,0,0,[e]
S:Lerror.raise_error$error$1_0$0({1}SC:U),R,0,0,[c]
T:Ferror$__00000000[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
T:Ferror$__00000001[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
T:Ferror$__00000002[({0}S:S$npads$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({4}S:S$joy3$0_0$0({1}SC:U),Z,0,0)({1}S:S$joypads$0_0$0({4}DA4d,SC:U),Z,0,0)]
T:Ferror$__00000003[({0}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy3$0_0$0({1}SC:U),Z,0,0)({0}S:S$joypads$0_0$0({4}DA4d,SC:U),Z,0,0)]
T:Ferror$__00000004[({0}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy3$0_0$0({1}SC:U),Z,0,0)]
T:Ferror$_fixed[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)({0}S:S$b$0_0$0({2}ST__00000001:S),Z,0,0)({0}S:S$w$0_0$0({2}SI:U),Z,0,0)]
T:Ferror$OAM_item_t[({0}S:S$y$0_0$0({1}SC:U),Z,0,0)({1}S:S$x$0_0$0({1}SC:U),Z,0,0)({2}S:S$tile$0_0$0({1}SC:U),Z,0,0)({3}S:S$prop$0_0$0({1}SC:U),Z,0,0)]
S:Ferror$__EMU_PROFILER_INIT$0_0$0({2}DG,SV:S),E,0,0
...
S:Ferror$who_error$0_0$0({1}SC:U),E,0,0
S:Ferror$error_num$0_0$0({1}SC:U),E,0,0
