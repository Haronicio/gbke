...
F:G$main$0_0$0({2}DF,SV:S),C,0,32,0,0,0
S:Lmain.main$task_0$1_1$134({2}DG,STtask_t:S),R,0,0,[e,d]
S:Lmain.main$t$1_2$135({2}DG,STtask_t:S),R,0,0,[]
S:Lmain.main$i$1_2$135({1}SC:U),R,0,0,[]
S:Lmain.main$buff$1_3$138({32}DA32d,SC:S),B,1,-32
...
T:Fmain$data_t[({0}S:S$data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$flags$0_0$0({30}DA15d,DG,SI:U),Z,0,0)({32}S:S$shared$0_0$0({30}DA15d,DG,STdata_t:S),Z,0,0)]
...
T:Fmain$task_t[({0}S:S$init_task_f$0_0$0({2}DC,DF,SV:S),Z,0,0)({2}S:S$update_task_f$0_0$0({2}DC,DF,SV:S),Z,0,0)({4}S:S$task_id$0_0$0({1}SC:U),Z,0,0)({5}S:S$task_period$0_0$0({1}SC:U),Z,0,0)({6}S:S$task_type$0_0$0({1}SC:U),Z,0,0)]
...
S:Fmain$__EMU_PROFILER_INIT$0_0$0({2}DG,SV:S),E,0,0
...
S:G$create_task$0_0$0({2}DF,DG,STtask_t:S),C,0,0
S:G$destroy_task$0_0$0({2}DF,SV:S),C,0,0
S:G$main$0_0$0({2}DF,SV:S),C,0,32
